        ...
        <div role="content">
            ...
            <div class="widget-body no-padding smart-form">
                ...
                <form action="/admin/deliveries/{{ $delivery->id }}" method="POST">
                    <header>
                        Modify a Payment: (ID: {{ $delivery->id }})
                    </header>
                    <?= csrf_field() ?>
                            ...
                            <label class="input">
                                <select class="form-control"
                                    ...
                                    @foreach($users as $user)
                                        <option {{ $delivery->recipient_id === $user->id ? 'selected="selected"' : '' }}
                                                value="{{ $user->id }}"
                                        >
                                            {{ $user->name }} ({{ $user->id }})
                                        </option>
                            ...
                            <label class="input">
                                <select class="form-control"
                                    ...
                                    @foreach($orders as $order)
                                        <option {{ $delivery->order_id === $order->id ? 'selected="selected"' : '' }}
                                                value="{{ $order->id }}"
                                        >
                            ...
                            <label class="input">
                                <select class="form-control"
                                    ...
                                    @foreach($couriers as $courier)
                                        <option {{ $delivery->courier_id === $courier->id ? 'selected="selected"' : '' }}
                                                value="{{ $courier->id }}"
                                        >
                                            {{ $courier->label }}
                                        </option>
